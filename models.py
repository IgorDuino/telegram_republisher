...
class Filter(Model):
    ...
    recipient_channel = fields.ForeignKeyField(
        "models.RecipientChannel", related_name="filters", null=True, on_delete=fields.CASCADE
    )
    donor_channel = fields.ForeignKeyField(
        "models.DonorChannel", related_name="filters", null=True, on_delete=fields.CASCADE
    )
